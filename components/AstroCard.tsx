        ...
        <div className="flex flex-col gap-1">
          ...
          {data.coordinates && (
            <div className="flex items-center gap-2 pl-14 text-[10px] text-gray-500 font-mono">
                <span>{data.coordinates.latitude.toFixed(4)}° N</span>
                <span className="w-1 h-1 rounded-full bg-gray-600"></span>
                <span>{data.coordinates.longitude.toFixed(4)}° E</span>
            </div>
          )}
        </div>
             ...
             {data.moonPosition && (
                 <div className="flex-1 flex items-center gap-3 p-3 bg-space-800/30 rounded-lg border border-space-700">
                    <div className="shrink-0">
                        <MoonPhaseIcon phase={data.moonPosition.phase} />
                    </div>
                    <div className="flex flex-col">
                        <span className="text-[10px] uppercase tracking-wider text-gray-500">Moon Phase</span>
                        <span className="text-xs font-medium text-indigo-100">{data.moonPosition.phase}</span>
                        <span className="text-[10px] text-gray-400">{data.moonPosition.constellation}</span>
                    </div>
                 </div>
             )}
